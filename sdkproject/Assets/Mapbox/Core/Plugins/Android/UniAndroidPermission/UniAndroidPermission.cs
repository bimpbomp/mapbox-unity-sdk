...
public class UniAndroidPermission : MonoBehaviour
{
	...
	public static void RequestPermission(AndroidPermission permission, Action onAllow = null, Action onDeny = null,
	...
	{
		if (onAllowCallback != null) onAllowCallback();
		ResetAllCallBacks();
	}

	private void OnDeny()
	{
		if (onDenyCallback != null) onDenyCallback();
		ResetAllCallBacks();
	}

	private void OnDenyAndNeverAskAgain()
	{
		if (onDenyAndNeverAskAgainCallback != null) onDenyAndNeverAskAgainCallback();
		ResetAllCallBacks();
	}
