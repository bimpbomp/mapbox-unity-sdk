...
namespace Mapbox.MapMatching
{
	...
	public class MapMatchingResource : Resource
	{
		...
		///     <para>
		///         Allowed values are: geojson (as LineString ), polyline with precision 5,  polyline6 (polyline with precision
		///         6).
		///     </para>
		...
		/// </summary>
		public InstructionLanguages? Language;


		/// <summary>
		///     <para>Type of returned overview geometry.</para>
		///     <para>
		///         Can be full (the most detailed geometry available), simplified (a simplified version of the full geometry),
		///         or none (no overview geometry).
		///     </para>
		...
		public Vector2d[] Coordinates
		{
			...
			set
			{
				if (null == value) throw new Exception("Coordinates cannot be null.");
		...
		public long[] Timestamps
		{
			...
			set
			{
				...
				if (value.Length != _coordinates.Length)
					throw new Exception("There must be as many timestapms as there are coordinates in the request.");
		...
		{
			if (null == _coordinates) throw new Exception("Coordinates cannot be null.");
