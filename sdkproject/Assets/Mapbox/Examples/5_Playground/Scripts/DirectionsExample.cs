...
namespace Mapbox.Examples.Playground
{
	...
	public class DirectionsExample : MonoBehaviour
	{
		...
		[SerializeField] private ForwardGeocodeUserInput _startLocationGeocoder;

		[SerializeField] private ForwardGeocodeUserInput _endLocationGeocoder;
		...
		private void HandleDirectionsResponse(DirectionsResponse res)
		{
			...
			var sub = data.Substring(0, data.Length > 5000 ? 5000 : data.Length) + "\n. . . ";
