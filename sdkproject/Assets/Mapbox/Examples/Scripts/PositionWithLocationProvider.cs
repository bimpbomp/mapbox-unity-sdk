...
namespace Mapbox.Examples
{
	public class PositionWithLocationProvider : MonoBehaviour
	{
		...
		/// </summary>
		[SerializeField] private float _positionFollowFactor;
		...
		///     This is public so you change which concrete <see cref="T:Mapbox.Unity.Location.ILocationProvider" /> to use at
		///     runtime.
		/// </summary>
