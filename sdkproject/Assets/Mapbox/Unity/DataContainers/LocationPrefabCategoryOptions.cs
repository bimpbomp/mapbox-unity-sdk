...
namespace Mapbox.Unity.Map
{
	...
	{
		private static readonly Dictionary<LocationPrefabCategories, List<string>> CategoriesToMakiDictionary = new()
		{
			{
			...
			{
				LocationPrefabCategories.Food, new List<string>
				{
					"cafe",
					"bakery",
					"fast-food",
			...
			{
				LocationPrefabCategories.Services, new List<string>
				{
					"bank",
					"dentist",
					"toilet",
			...
			{
				LocationPrefabCategories.Transportation, new List<string>
				{
					"bus",
					"car",
					"bicycle-share",
		...
		private static readonly Dictionary<string, LocationPrefabCategories> MakiToCategoriesDictionary = new();
		...
		private static void PopulateCategoriesToMakiDictionary()
		{
			...
			foreach (var makiTag in item.Value)
		...
		/// <param name="category">
		///     <see cref="LocationPrefabCategories" />
		/// </param>
