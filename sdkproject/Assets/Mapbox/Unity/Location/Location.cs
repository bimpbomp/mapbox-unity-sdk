...
namespace Mapbox.Unity.Location
{
	...
	public struct Location
	{
		...
		///         <see cref="Mapbox.Unity.Location.IsHeadingUpdated" />
		///     </para>
		...
		/// <summary>
		///     Has the location been aquired via a GPS fix. 'Null' if not supported by the active location provider or GPS not
		///     enabled.
		/// </summary>
		public bool? HasGpsFix;

		/// <summary>
		///     How many satellites were in view when the location was acquired. 'Null' if not supported by the active location
		///     provider or GPS not enabled.
		/// </summary>
		public int? SatellitesInView;

		/// <summary>
		///     How many satellites were used for the location. 'Null' if not supported by the active location provider or GPS not
		///     enabled.
		/// </summary>
