...
namespace Mapbox.Unity.MeshGeneration.Data
{
	...
	public class AtlasInfo : ScriptableObject
	{
		...
		private readonly UnityEvent m_OnValidate = new();
			...
			if (AtlasEntityType == AtlasEntityType.TextureBased)
				foreach (var tex in Textures)
				{
					tex.FirstFloorHeight = tex.PreferredEdgeSectionLength *
					                       (tex.TextureRect.height * tex.BottomSectionRatio / tex.TextureRect.width);
					tex.TopFloorHeight = tex.PreferredEdgeSectionLength *
					                     (tex.TextureRect.height * tex.TopSectionRatio / tex.TextureRect.width);
					tex.FloorHeight = tex.PreferredEdgeSectionLength *
				...
				foreach (var tex in Textures)
				{
					tex.BottomSectionRatio = tex.FirstFloorHeight / tex.PreferredEdgeSectionLength *
						tex.TextureRect.width / tex.TextureRect.height;
					tex.TopSectionRatio = tex.TopFloorHeight / tex.PreferredEdgeSectionLength * tex.TextureRect.width /
