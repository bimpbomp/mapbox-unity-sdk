...
namespace Mapbox.Unity.MeshGeneration.Factories
{
	...
	{
		[SerializeField] private ImageryLayerProperties _properties;
		...
		private void OnImageRecieved(UnityTile tile, RasterTile rasterTile)
		{
			if (tile != null)
			{
				...
				if (tile.RasterDataState != TilePropertyState.Unregistered)
					tile.SetRasterData(rasterTile.Data, _properties.rasterOptions.useMipMap,
		...
		protected override void OnErrorOccurred(UnityTile tile, TileErrorEventArgs e)
		{
			...
			if (tile != null) tile.RasterDataState = TilePropertyState.Error;
		}
