...
namespace Mapbox.Unity.MeshGeneration.Modifiers
{
	...
	{
		[SerializeField] private bool _textureTop;

		[SerializeField] private bool _useSatelliteTexture;

		[SerializeField] private Material[] _topMaterials;

		[SerializeField] private bool _textureSides;

		[SerializeField] private Material[] _sideMaterials;
		...
		public override void Run(VectorEntity ve, UnityTile tile)
		{
			...
			if (_textureSides && _sideMaterials.Length > 0)
				...
				_meshRenderer.materials = new Material[1] { _topMaterials[Random.Range(0, _topMaterials.Length)] };
