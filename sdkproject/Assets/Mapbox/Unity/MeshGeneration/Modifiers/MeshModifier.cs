...
namespace Mapbox.Unity.MeshGeneration.Modifiers
{
	...
	///     MeshData class is used to keep data required for a mesh.Mesh modifiers recieve raw feature data and a mesh
	///     modifier,
	///     generate their data and keep it inside MeshData. i.e.PolygonMeshModifier is responsible for triangulating the
	///     polygon,
	///     so it calculates the triangle indices using the vertices and save it into MeshData.Triangles list.There's no
	///     control
	...
	///     You can always create gameobjects and debug lines/spheres inside them for debugging purposes whenever you have a
	///     problem.
	...
	///     We fully expect developers to create their own mesh modifiers to customize the look of their world.It would
	///     probably
